...
from Bertstat.torchstat import compute_madd
from Bertstat.torchstat import compute_flops
from Bertstat.torchstat import compute_memory
...
class ModelHook(object):
    def __init__(self, model, input_size):
        ...
        x = torch.randint(low=0, high=30521, size=self._input_size, dtype=torch.long)  # for bert
        self._model.eval()
        self._model(x)
